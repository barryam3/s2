...
class DataTable(object):
    ...
    """
    def __init__(self, mdl, cols, sortable, searchable, filterable, lim, req):
        self.model = mdl
    ...
    def get_selected(self, request):
        ...
        lim = self.limits[1]
        self.selected_limit = request.values.get('limit', lim, type=int)
    ...
    def search(self, search_query):
        ...
        if search_query:
            ...
            matches = [x.like(search_query) for x in fields]
            self.query = self.query.filter(or_(*matches))
